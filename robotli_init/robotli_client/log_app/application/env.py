...
# 本地工具箱
from .Tools.CommonTools.template import RowRender
...
row_render = RowRender(all_configs)
get_config = lambda config_name: row_render.render(all_configs.get(config_name, ""))
